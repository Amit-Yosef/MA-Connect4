...
namespace Data
{
    public struct ItemSwitcherButtonRequest<T>
    {
        ...
        private ItemSwitcherButtonRequest(bool canSwitch, List<T> options, RectTransform rectTransform)
        {
            CanSwitch = canSwitch;
            Options = options;
        ...
        public class Builder
        {
            ...
            public ItemSwitcherButtonRequest<T> Build()
            {
                return new ItemSwitcherButtonRequest<T>(_canSwitch, _options, _rectTransform);
            }
        }
    }
}