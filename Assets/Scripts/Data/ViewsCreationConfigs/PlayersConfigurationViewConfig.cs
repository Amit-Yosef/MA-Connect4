namespace Data
{
    ...
    public struct PlayersConfigurationViewConfig
    {
        ...
        private PlayersConfigurationViewConfig(
        ...
        public class Builder
        {
            ...
            public PlayersConfigurationViewConfig Build()
            {
                return new PlayersConfigurationViewConfig(
                    _diskOptions,
                    _strategyOptions,
                    _parentTransform,
                    _playersCount,
